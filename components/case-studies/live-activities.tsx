...
export const liveActivitiesToc = [
  ...
  { id: "discovery", label: "Discovery & Pattern Analysis" },
  { id: "defining-goals", label: "Defining Goals & Stakeholder Needs" },
  { id: "how-might-we", label: "How Might We" },
  { id: "design-principles", label: "Design Principles" },
  { id: "master-template", label: "The Master Template" },
  { id: "three-types", label: "The Three Live Activity Types" },
