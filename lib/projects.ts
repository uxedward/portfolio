...
export const projects: Project[] = [
  ...
  },
  {
    ...
    bullets: ["123k+ followers"],
    outcome: "123k+ followers",
    metrics: [{ value: "123k+", label: "Followers" }],
  ...
  },
  {
    ...
    bullets: ["95k+ followers"],
    outcome: "95k+ followers",
    metrics: [{ value: "95k+", label: "Followers" }],
